...
public class CreditTest {
	...
	private static final Day END_OF_FIRST_YEAR = Day.lastDayOfYear(2008);
	private static final Day BEFORE_END_OF_FIRST_YEAR = END_OF_FIRST_YEAR.addDays(-1);
	private static final Day FIRST_DAY_OF_SECOND_YEAR = Day.firstDayOfYear(2009);
	private static final Day FIRST_MONTH_OF_SECOND_YEAR = Day.firstDayOfYear(2009);
	private static final Day END_OF_SECOND_YEAR = Day.lastDayOfYear(2009);
	private static final Day FIRST_DAY_OF_THIRD_YEAR = Day.firstDayOfYear(2010);
	private static final Day END_OF_THIRD_YEAR = Day.lastDayOfYear(2010);
	...
	public void testAnnualInterest() throws Exception {
		Credit credit = new Credit(Day.firstDayOfYear(2008), END_OF_THIRD_YEAR, CREDIT_AMOUNT, INTEREST_RATE);
	...
	public void testPartialAnnualInterest() throws Exception {
		Credit credit = new Credit(Day.of(2008, Month.MARCH, 1), END_OF_THIRD_YEAR, CREDIT_AMOUNT, INTEREST_RATE);
	...
	public void testPartialAnnualInterest2() throws Exception {
		Credit credit = new Credit(Day.of(2008, Month.DECEMBER, 1), END_OF_THIRD_YEAR, CREDIT_AMOUNT, INTEREST_RATE);
	...
	public void testMonthlyPayment2Month() throws Exception {
		Credit credit = new Credit(Day.of(2008, Month.NOVEMBER, 1), END_OF_THIRD_YEAR, CREDIT_AMOUNT, INTEREST_RATE);
		credit.setPayment(new BigDecimal("300"));
	...
	public void yearlyPaimentFirstYear() throws Exception {
		Credit credit = new Credit(Day.of(2008, Month.OCTOBER, 1), END_OF_THIRD_YEAR, CREDIT_AMOUNT, INTEREST_RATE);
		...
		Day firstPayment = Day.of(2009, Month.OCTOBER, 1);
		// 48000 + 480 - 5000

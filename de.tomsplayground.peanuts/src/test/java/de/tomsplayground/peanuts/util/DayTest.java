...
public class DayTest {
	...
	public void testEquals() throws Exception {
		Day d1 = Day.of(2008, 0, 31);
		Day d2 = Day.of(2008, 0, 31);
		Day d3 = Day.of(2008, 0, 30);
	...
	public void testFromLocalDate() throws Exception {
		...
		assertEquals(Day.of(2008, 2, 12), d);
	}

	@Test
	public void testCompare() throws Exception {
		Day d1 = Day.of(2008, 0, 30);
		Day d2 = Day.of(2008, 0, 31);
	...
	public void testFromString() throws Exception {
		...
		assertEquals(Day.of(2008, 4, 1), d);
	...
	public void testToString() throws Exception {
		Day d = Day.of(2008, 4, 1);
		assertEquals("2008-5-1", d.toString());
	}

	@Test
	public void addDays() throws Exception {
		Day d = Day.of(2008, 1, 28);
		Day d2 = d.addDays(2);
		Day d3 = d.addDays(-28);

		assertEquals(Day.of(2008, 2, 1), d2);
		assertEquals(Day.of(2008, 0, 31), d3);
	}
	...
	public void addYear() {
		...
		assertEquals(Day.of(2009, 1, 28), d2);
	}

	@Test
	public void addMonth() throws Exception {
		Day d = Day.of(2008, 0, 31);
		Day d2 = d.addMonth(1);
		Day d3 = d.addMonth(-2);

		assertEquals(Day.of(2008, 1, 29), d2);
		assertEquals(Day.of(2007, 10, 30), d3);
	}

	@Test
	public void delta() {
		Day d1 = Day.of(2008, 0, 2);
		Day d2 = Day.of(2008, 0, 2);
	...
	@Test
	public void delta2() {
		Day d1 = Day.of(2008, 0, 1);
		Day d2 = Day.of(2008, 6, 1);
